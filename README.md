# README from JS Mastery original project

<div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
        <div>⭐⭐⭐ Go give him a star ⭐⭐⭐</div>
            <div>
                <a href="https://github.com/adrianhajdin/ai-resume-analyzer">
    https://github.com/adrianhajdin/ai-resume-analyzer</a>
            </div>
</div>
...
<a href="https://www.youtube.com/watch?v=iYOz165wGkQ" target="_blank">
  ...
  <div style="display: flex; justify-content: center; align-items: center; height: 100px;">
    ...
    <img src="https://img.shields.io/badge/-Tailwind-38B2AC?
...
tutorial to learn how to build projects like these, step-by-step, in a beginner-friendly 
manner!
...
👉 **AI resume matching**: Provide a job listing and get an ATS score with custom 
